...
public class Annotation extends org.apache.uima.jcas.tcas.Annotation {
  ...
  //*--------------*
  //* Feature: goldStandard

  /** getter for goldStandard - gets 
   * @generated */
  public int getGoldStandard() {
    if (Annotation_Type.featOkTst && ((Annotation_Type)jcasType).casFeat_goldStandard == null)
      jcasType.jcas.throwFeatMissing("goldStandard", "edu.cmu.deiis.types.Annotation");
    return jcasType.ll_cas.ll_getIntValue(addr, ((Annotation_Type)jcasType).casFeatCode_goldStandard);}
    
  /** setter for goldStandard - sets  
   * @generated */
  public void setGoldStandard(int v) {
    if (Annotation_Type.featOkTst && ((Annotation_Type)jcasType).casFeat_goldStandard == null)
      jcasType.jcas.throwFeatMissing("goldStandard", "edu.cmu.deiis.types.Annotation");
    jcasType.ll_cas.ll_setIntValue(addr, ((Annotation_Type)jcasType).casFeatCode_goldStandard, v);}    
  }
