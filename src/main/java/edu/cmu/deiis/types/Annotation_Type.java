...
public class Annotation_Type extends org.apache.uima.jcas.tcas.Annotation_Type {
  ...
  /** @generated */
  final Feature casFeat_goldStandard;
  /** @generated */
  final int     casFeatCode_goldStandard;
  /** @generated */ 
  public int getGoldStandard(int addr) {
        if (featOkTst && casFeat_goldStandard == null)
      jcas.throwFeatMissing("goldStandard", "edu.cmu.deiis.types.Annotation");
    return ll_cas.ll_getIntValue(addr, casFeatCode_goldStandard);
  }
  /** @generated */    
  public void setGoldStandard(int addr, int v) {
        if (featOkTst && casFeat_goldStandard == null)
      jcas.throwFeatMissing("goldStandard", "edu.cmu.deiis.types.Annotation");
    ll_cas.ll_setIntValue(addr, casFeatCode_goldStandard, v);}
  ...
  public Annotation_Type(JCas jcas, Type casType) {
    ...
    casFeat_goldStandard = jcas.getRequiredFeatureDE(casType, "goldStandard", "uima.cas.Integer", featOkTst);
    casFeatCode_goldStandard  = (null == casFeat_goldStandard) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_goldStandard).getCode();
