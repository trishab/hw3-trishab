...
public class Answer extends Annotation {
  ...
  public TOP getSentenceArray(int i) {
    ...
    return (TOP)(jcasType.ll_cas.ll_getFSForRef(jcasType.ll_cas.ll_getRefArrayValue(jcasType.ll_cas.ll_getRefValue(addr, ((Answer_Type)jcasType).casFeatCode_sentenceArray), i)));}
